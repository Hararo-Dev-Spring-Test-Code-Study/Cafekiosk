...
class MailServiceTest {
    ...
    void setUp() {
        ...
        mailService = new MailService(orderRepository, mailRepository);
    }
    ...
    void sendSalesSummaryMail_주문_매출_메일저장_확인() {
        ...
        // given
        given(orderRepository.findCompletedOrdersByDate(targetDate))
        ...
        // then
        then(orderRepository).should(times(1)).findCompletedOrdersByDate(targetDate);
